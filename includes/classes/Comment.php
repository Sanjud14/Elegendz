...
class Comment
{
    ...
    public function create()
    {
        ...
        return "<div class='itemContainer' id='comment_$id'>
                    <div class='comment'>
                        $profileButton

                        <div class='mainContainer text-start'>

                            <div class='commentHeader'>
                                <a href='/$postedBy'><span class='username'>$postedBy</span></a>
    ...
    {
        $query = $this->con->prepare("SELECT count(*) FROM comments WHERE responseTo=:responseTo AND deleted = 0");
    ...
    {
        $query = $this->con->prepare("SELECT * FROM comments WHERE responseTo=:commentId AND deleted = 0 ORDER BY datePosted ASC");
        $query->bindParam(":commentId", $id);
    ...
    {
        $query = $this->con->prepare("UPDATE comments SET deleted=1 WHERE id =:id");
        $id = $this->getId();
